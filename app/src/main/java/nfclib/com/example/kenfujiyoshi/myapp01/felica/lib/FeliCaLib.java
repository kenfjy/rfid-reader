 ...
 */
package nfclib.com.example.kenfujiyoshi.myapp01.felica.lib;
...
import nfclib.com.example.kenfujiyoshi.myapp01.felica.IFeliCaByteData;
import nfclib.com.example.kenfujiyoshi.myapp01.felica.command.IFeliCaCommand;
...
public final class FeliCaLib {
    ...
    public static class CommandPacket implements IFeliCaCommand {
        ...
        /* (non-Javadoc)
         * @see net.com.example.kenfujiyoshi.myapp01.felica.IFeliCaCommand#getIDm()
         */
        @Override
        public IDm getIDm() {
            return this.idm;
    ...
    public static class IDm implements Parcelable, IFeliCaByteData {
        ...
        /* (non-Javadoc)
         * @see net.com.example.kenfujiyoshi.myapp01.felica.IFeliCaByteData#getBytes()
         */
        @Override
        public byte[] getBytes() {
